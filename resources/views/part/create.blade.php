...
<script type="text/javascript">
	var part_names = [@foreach($parts as $part) "{{$part->name}}", @endforeach];
    ...
    <form action="/part/store" method="post" class="form-horizontal form-bordered">
    	@csrf
        <div class="form-group">
            <label class="col-md-3 control-label" for="example-hf-email">Part Name</label>
            <div class="col-md-9">
                <input id="part_name" type="text" name="name" class="form-control" required onchange="check_part_name()">
